      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <input
            ...
            className="w-full rounded-2xl border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none transition focus:border-cyan-400 lg:max-w-md"
          />
          ...
          {!isTeacher ? (
            <label className="flex items-center gap-2 text-sm text-slate-300">
              <input
                ...
                className="rounded border-slate-600 bg-slate-950 text-cyan-500 focus:ring-cyan-400"
              />
